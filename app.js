...
document.getElementById("sign-transaction-btn").onclick = async () => {
  ...
  document.getElementById("result").innerHTML =
    ...
    "</p>";
  document.getElementById("resultJSON").innerHTML = JSON.stringify(
    response,
    null,
    2
  );
...
document.getElementById("test-address-policies-btn").onclick = async () => {
  const response = await trezorConnectTest.testAddressPolicies();
  document.getElementById("result").innerHTML = "<p>" + response;
};
